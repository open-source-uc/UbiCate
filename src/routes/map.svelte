<script context="module" lang="ts">
	import { Place, places } from '$constants/places';
	import { categories } from '$constants/categories';

	// TODO: añadir algoritmo de busqueda decento (con WebAssembly?)
...
<script lang="ts">
	...
	let locationButtom: HTMLElement;
...
<div id="mapContainer">
	<Map {locationButtom} {results} {onMarkerClick} bind:currentLocation bind:location bind:zoom />
</div>
...
<div id="mainContainer" class:solid={isInFocus}>
	...
	{#if isInFocus}
		...
		<div class="results-container ss">
			{#if query}
				{#each results as { name, latLng: [lat, lng], id }, index (id)}
	...
	{:else}
		...
		<div id="interactionArea">
			...
			<FAB bind:self={locationButtom} iconName="my_location" isSecondary />
		</div>
